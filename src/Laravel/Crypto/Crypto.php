...
class Crypto {
	...
	function __construct(array $config = []) {
		...
		if (!isset($config['ENCRYPT_INIT_KEY'])) {
            $config['ENCRYPT_INIT_KEY'] = 'aaaaaaaaaaaaaaa';
        }

        if (!isset($config['ENCRYPT_INIT_VECTOR'])) {
            $config['ENCRYPT_INIT_VECTOR'] = 'bbbbbbbbbbbbbbbb';
        }

		$this->_INIT_KEY = $config['ENCRYPT_INIT_KEY'];
		$this->_INIT_VECTOR = $config['ENCRYPT_INIT_VECTOR'];
